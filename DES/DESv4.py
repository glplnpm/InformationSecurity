...
def feistel_function(right, subkey):
    ...
    xor_result = format(int(expanded_right, 2) ^ int(subkey, 2), '048b')
    substitution_result = substitution(xor_result)
    permutation_result = permute(substitution_result, [
